...
var content = `
    ...
    `;
        ...
        twoObjects.appendChild(MakeObj("Password Security", "pics/passwordProt.webp", "Secure your passwords!"));
        twoObjects.appendChild(MakeObj("Password Manager", "pics/PassMan.png", "All your passwords here in one place!"));
        var trailer = document.createElement("p");
        trailer.innerHTML = "Hope you liked my temp objects!";
